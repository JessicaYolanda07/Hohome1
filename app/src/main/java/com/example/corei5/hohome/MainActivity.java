...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_venta) {
            ...
            this.startActivity(venta);
        } else if (id == R.id.nav_alquiler) {
            Intent alquiler = new Intent(this, Alquiler.class);
            ...
            Intent proyecto = new Intent(this, Proyecto.class);
            this.startActivity(proyecto);

        }else if (id == R.id.nav_busqueda) {
            Intent busqueda = new Intent(this, Busqueda.class);
